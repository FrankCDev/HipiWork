...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.hipi/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.hipi/skills/inspect/SKILL.md">\nReferences are relative to /project/.hipi/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
