...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as HIPI_OFFLINE=1)
...
${chalk.bold("Environment Variables:")}
  ...
  HIPI_PACKAGE_DIR                 - Override package directory (for Nix/Guix store paths)
  HIPI_OFFLINE                     - Disable startup network operations when set to 1/true/yes
  HIPI_TELEMETRY                   - Override provider attribution headers when set to 1/true/yes or 0/false/no
  HIPI_LATEST_VERSION_URL          - Release feed checked at startup; unset disables the version check
  HIPI_SHARE_VIEWER_URL            - Base URL for /share; unset disables /share
