 ...
 * Encodes cwd into a safe directory name under ~/.hipi/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.hipi/agent/sessions/<encoded-cwd>/).
	 */
