 ...
 * - ~/.hipi/agent/extensions/sandbox.json (global)
 * - <cwd>/.hipi/sandbox.json (project-local)
 *
 * Example .hipi/sandbox.json:
 * ```json
 * {
 *   "enabled": true,
 *   "network": {
 ...
 *
 * Setup:
 * 1. Copy sandbox/ directory to ~/.hipi/agent/extensions/
 * 2. Run `npm install` in ~/.hipi/agent/extensions/sandbox/
 *
