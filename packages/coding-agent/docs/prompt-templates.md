> hipi can create prompt templates. Ask it to build one for your workflow.
...
hipi loads prompt templates from:

- Global: `~/.hipi/agent/prompts/*.md`
- Project: `.hipi/prompts/*.md` (only after the project is trusted)
