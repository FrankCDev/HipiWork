...
// ============================================================================
// OAuth API key resolution from ~/.hipi/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".hipi", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.hipi/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.hipi/agent/auth.json
 */
...
export const HIPI_AGENT_DIR = join(homedir(), ".hipi", "agent");

/**
 * Get an AuthStorage instance backed by ~/.hipi/agent/auth.json
