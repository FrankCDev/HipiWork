...
const agentDirEnvName = "HIPI_CODING_AGENT_DIR";
const startupBenchmarkEnvName = "HIPI_STARTUP_BENCHMARK";
...
Options:
  ...
  --agent-dir <dir>      Use a specific HIPI_CODING_AGENT_DIR for the benchmark run
  ...
  --no-offline           Do not force HIPI_OFFLINE=1 / HIPI_SKIP_VERSION_CHECK=1
...
function createBenchmarkEnv(options, isolatedAgentDir) {
	const env = { ...process.env, HIPI_TIMING: "1" };
	if (options.agentDir) {
