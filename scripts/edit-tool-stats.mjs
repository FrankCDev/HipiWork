...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".hipi/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".hipi/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.hipi/agent/sessions)
